...
If multiple accounts have been created and automatic login is set, the application will log in as the first user. 
The first user is also the administrator.
